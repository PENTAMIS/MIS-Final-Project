...
<html>
  ...
  <body onload="loadValues();">
                ...
                <table class="PAssign">
                    <tbody id="test">
                        ...
                        <tr class="PS-3">
                            ...
                            <td class="PS3-2">
                                <input id="input1" type="text" value="<?php echo $x; ?>" name=<?php echo "missionMembers$y$x"; ?>>
                            </td>
                            <td class="PS3-3">
    ...
    $(document).on("click", ".plus", function() {
            $(this).parent().find("#test").append('<tr class="PS-3"> <td class="PS3-1"> <input id="input1" type="text" value="' + window.y + window.x + '" name="missionName' + window.y + window.x + '"> </td> <td class="PS3-2"> <input id="input1" type="text" name="missionMembers' + window.y + window.x + '"> </td> <td class="PS3-3"> <input id="input2" type="date" id="bookdate" name="missionDate' + window.y + window.x + '" placeholder="2014-09-18"> </td>  <td class="PS3-4"><textarea id="input3" class="form-control" rows="1" name="missionContent'+ window.y + window.x + '" placeholder=""></textarea></td><td id="PS3-7"></td><td id="PS3-5"><input type="checkbox" name="missionFile' + window.x +  '" value=""></td><td></td><td id="PS3-6"></td> </tr>');
        });
