...
<head>
	<title>test3</title>
	<link rel="stylesheet" href="Pcale.css">
	...
	<script>
		...
		function showCalendar(str) {
		    var URL='showCalendar_project.php?id=<?php echo $_GET['id']; ?>'
		     $.ajax({
                url: URL,
                data: "month="+str,
                type:"GET",
					        ...
					        buttons: [
						        {
						            ...
						            click: function(){
								        document.location.href='ADEvent.php?id=<?php echo $_GET['id']; ?> sel=0&data='+mission_id;
						            }
						        },
						        {
						            text: "Edit",
								    ...
								    click: function() {
								        document.location.href="editEvent.php?sel=0&id="+mission_id;
								    }
						        }
						    ],
							open: function(){
                	...
                	$(".cal").on("click", "td", function() {
                		if(first_click==0){
	                		...
	                		if(mission_date!=0){
		                		...
		                		$('#mission_create_time').text(now_month+","+mission_date+"("+mission_weekday+")");
							        ...
							        buttons: [
								        {
								            ...
								            "class": 'EditButtonClass',
								            click: function() {
								        		document.location.href="editEvent.php?sel=1&date="+fullDate;
								            }
								        },
								        {
								            text: "Create",
								            ...
								            click: function() {
								        		...
								        		document.location.href="ADEvent.php?id=<?php echo $_GET['id']; ?>&sel=1&date="+fullDate+"&data="+name;
								            }
								        }
								    ],
								...
								if(mission_weekday==5||mission_weekday==6){
									$( "#mission_create" ).dialog( "option", "position", { my: "left-280 top ", at: "left bottom", of: $(this) } );
								}
								else{
									$( "#mission_create" ).dialog( "option", "position", { my: "left top", at: "left bottom", of:  $(this) } );
...
<button class="Mbtn" onclick="month_change(0)"><img class="right" src="images/arrow-left.png"></button>
...
<button class="Mbtn" onclick="month_change(1)"><img class="right" src="images/arrow-right.png"></button>

</div>
<div id="calendar"></div>

<div id="mission_dialog" title="">
	When<br>
